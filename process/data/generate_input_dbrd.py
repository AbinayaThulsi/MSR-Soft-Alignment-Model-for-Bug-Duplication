...
Example:
    python generate_input_dbrd
     --database DATASET_DIR/sun_2011/mozilla_2001-2009_2010/mozilla_initial.json
     --test DATASET_DIR/sun_2011/mozilla_2001-2009_2010/test_mozilla.txt
     --output DATASET_DIR/sun_2011/mozilla_2001-2009_2010/dbrd_test.txt
...
from preprocessing import ClassicalPreprocessing, MultiLineTokenizer, \
    HTMLSymbolFilter
...
class DBRDPreprocessing(ClassicalPreprocessing):
    ...
    def __init__(self):
        super(DBRDPreprocessing, self).__init__(MultiLineTokenizer(), SnowballStemmer('english', ignore_stopwords=True),
                                                set(stopwords.words('english') + list(string.punctuation) + ["n't",
                                                                                                             "'t"]),
                                                [HTMLSymbolFilter()])
